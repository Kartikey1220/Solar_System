...
// If this is the rocky-surface, lock camera to it
...
function init() {
  ...
  scene.add(ambientLight);
   ...
   function step() {
    ...
    object.position.z += speedX * 0.3;  // diagonal movement with Z component
  ...
  astroMesh.position.set(600, 230, -300);
...
function createGradientTexture() {
 ...
 astroLight.castShadow = true;
  ...
  playBtn.addEventListener('click',() =>{
    MovetheObject(astroMesh, -2.0, -1.0);  // diagonal downward animation
  })
